...
void print_time(clock_t start, clock_t end)
{
    ...
    cout << "Running time (if required): " << time_use << " second.\n";
}
void print_comparision(unsigned long int count_comp)
{
    cout << "Comparisions (if required): " << count_comp << endl;
}
...
void command_3(string mode, string algorithm, string input_size, string output_parameter)
{
    ...
    if (algorithm == "heap-sort")
    {
        ...
        if (output_parameter == "-time" || output_parameter == "-both") print_time(start, end);
        if (output_parameter == "-comp" || output_parameter == "-both") print_comparision(cnt_compare);
...
{
    //cout << algorithm1 << ' ' << algorithm2 << ' ' <<  input_size << ' ' << input_order << ' '  << endl;
    n = input_size;
...
//    //else
//    //{
//    string amount[6] = { "10000","30000","50000","100000","300000","500000" };
//    string type[4] = { "Sorted","NearlySorted","Reverse","Random"};
//        cout << "Input action: ";
//        cin >> action;
...
//        for (int i = 3; i < 4; i++)
//        {
//            string input_file = type[i];
//            for (int j = 4; j < 5; j++)
//            {
//                cout << endl;
//                cnt_compare = 0;
//                input_file = type[i];
//                input_file = input_file + '_' + amount[j] + ".txt";
//                command_1(action, algorithm, input_file, output_parameter);
//            }
//        }
//    
